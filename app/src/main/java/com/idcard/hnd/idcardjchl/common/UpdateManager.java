...
public class UpdateManager {
	 ...
	 */
	public void checkAppUpdate(Context context, final boolean isShowMsg,final String str){
		...
		new Thread(){
			public void run() {
				...
				try {
					Update update = ApiClient.checkVersion((AppContext)mContext.getApplicationContext(),str);
					msg.what = 1;
					msg.obj = update;
